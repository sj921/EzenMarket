...
INSERT INTO userlist(user_number, user_name, user_id, user_pw, nickname, phonenumber, email, user_image) values(user_number_seq.nextval,'전인재','qwert1', 'YQCaawZtfTgCs8Ah/APHAlK_e_CjPkdgHT', '짱짱인재zz', '01012345678', 'dlswo1234@gmail.com', 'https://s.pstatic.net/shopping.phinf/20220308_28/8e811a9e-1c0f-4313-ad60-0b0ee9872029.jpg?type=f214_292');

INSERT INTO userlist(user_number, user_name, user_id, user_pw, nickname, phonenumber, email, user_image) values(user_number_seq.nextval,'김철수', 'qwert2', 'AFvIBn_ihXRTW4xyWpOTJPUrmprYlWJoN7hiewkRkuE6GbSIg', '철철철수', '01087654321', 'cjftn123@naver.com', 'https://naverpa-phinf.pstatic.net/MjAyMjEyMDdfMTc2/MDAxNjcwMzg1MDc0NDA5.T155TC3cDdY0WgLl2keblW4pqHuk2PJMfQLzoXHHF5Ig.VPg5TrpdllpD0FOC5mlN-baxxGQ-JdJmiLXjxshDhP8g.JPEG/221207_gfa_16703850743931154144555135500874.jpg');

INSERT INTO category VALUES(category_id_seq.nextval, '남성의류');

INSERT INTO city VALUES(1, '구리시', '인창동');

INSERT INTO address VALUES(address_id_seq.nextval, 1, 1);

INSERT INTO post(post_id, user_number, address_id, title, category_id, price) VALUES(post_id_seq.nextval, 1, 1, '찢어진 청바지 팔아요', 1, 7500);
