...
<head>
	...
	* { margin:0; padding:0; font-size:15px; line-height:1.3;  }
	...
	.member-image .member-image-box { width: 60px; height: 60px; border-radius: 70%; overflow: hidden; margin-left: 60px; margin-top: 10px; }	
	.member-image img { width: 100%; height: 100%; object-fit: cover; float: left; }
		
	/*작성자 닉네임, 작성날짜, 내용 위치*/
	.member-image .title { font-weight: 900; font-size: 1.1em; text-align: left; margin-top: -50px; margin-left: 7em; }	
	.member-image .time-ago { text-align: left; margin-top: 0; margin-left: 10em; }	
	.member-box { text-align: left; margin-top: 2em; margin-left: 9.3em; margin-bottom: 2em; }	
	.item-review-title { color: cornflowerblue; margin-bottom: 1em; margin-top: -1em;}	
									...
									<li id="tab3" class="btnCon">
										...
										<div class="tabCon">
											<div class="review-section">
												<span style="font-size: 1.2em; font-weight: 700; margin-left: 20px; ">후기</span>
																...
																<c:forEach items="${review }" var="review">
																	<div class="review-div">													
																		...
																		<div class="member-box">
																			<div class="item-review-title">${review.title }</div>
																			<!--구매한 상품 이름-->
																			<span class="description" width="0"> <span>
