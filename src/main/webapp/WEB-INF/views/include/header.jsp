...
<body>
	  <div id="box">
		 <header>
          ...
          <nav class="head">
            <a class="logo" href="">Ezen<i class="fa-brands fa-monero logoIcon"></i>arket</a>
           <div class="searchbox">
          ...
          <div class="LastHead">
            ...
            <div><i class="fa-solid fa-won-sign icon Like"></i><a class="lastHead like" href="register"> 판매하기 </a></div>
            </div>
