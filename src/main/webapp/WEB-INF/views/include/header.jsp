		 ...
		 <header>
          ...
          <nav class="topMenu">
            <ul>
              ...
              <li><a class="menuLink a-tag" href="<%=request.getContextPath() %>/logout" style="font-size: 1em;">로그아웃</a></li>     
              <li><span id="user_nickname" style="font-size: 1em;">${sessionScope.nickname}</span> 님</li>
              </c:when>
          ...
          <nav class="head">
            <a class="logo a-tag" href="<%=request.getContextPath()%>">Ezen<i class="fa-brands fa-monero logoIcon" style="font-size: 1em;"></i>arket</a>
