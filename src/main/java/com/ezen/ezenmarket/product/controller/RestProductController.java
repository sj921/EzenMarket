...
//   @PostMapping(value = {"/product/zzim"})
//   public ModelAndView alreadyExistZzim(Integer user_number, Integer post_id) {
//      log.info("찜 요청을 받았습니다.");
// 
//      if(productMapper.countNumOfZzim(user_number, post_id) > 0) {
//         productMapper.deleteZzim(user_number, post_id);
//         ModelAndView mav = new ModelAndView ("redirect:/product?id=" + post_id);
//         return mav;  
//      } else {
//         productMapper.insertZzim(user_number, post_id);
//         ModelAndView mav = new ModelAndView ("redirect:/product?id=" + post_id);
